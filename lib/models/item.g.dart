...
const ItemSchema = CollectionSchema(
  ...
  properties: {
    r'isBought': PropertySchema(id: 0, name: r'isBought', type: IsarType.bool),
...
Item _itemDeserialize(
  ...
  final object = Item();
  object.id = id;
  object.isBought = reader.readBool(offsets[0]);
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> isBoughtEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension ItemQuerySortBy on QueryBuilder<Item, Item, QSortBy> {
  QueryBuilder<Item, Item, QAfterSortBy> sortByIsBought() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByIsBoughtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQuerySortThenBy on QueryBuilder<Item, Item, QSortThenBy> {
  ...
  QueryBuilder<Item, Item, QAfterSortBy> thenByIsBought() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByIsBoughtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.desc);
    });
  }
...
extension ItemQueryWhereDistinct on QueryBuilder<Item, Item, QDistinct> {
  QueryBuilder<Item, Item, QDistinct> distinctByIsBought() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQueryProperty on QueryBuilder<Item, Item, QQueryProperty> {
  ...
  QueryBuilder<Item, bool, QQueryOperations> isBoughtProperty() {
    return QueryBuilder.apply(this, (query) {
