...
extension ShoppingItemQueryWhere
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ShoppingItemQuerySortBy
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> sortByIsBought() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.asc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> sortByIsBoughtDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> sortByPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.asc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> sortByPriceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.desc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> sortByQuantity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'quantity', Sort.asc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> sortByQuantityDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ShoppingItemQuerySortThenBy
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> thenByIsBought() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.asc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> thenByIsBoughtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.desc);
    });
  }
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> thenByPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.asc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> thenByPriceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.desc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> thenByQuantity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'quantity', Sort.asc);
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QAfterSortBy> thenByQuantityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'quantity', Sort.desc);
    });
  }
...
extension ShoppingItemQueryWhereDistinct
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QDistinct> distinctByIsBought() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QDistinct> distinctByPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'price');
    });
  }

  QueryBuilder<ShoppingItem, ShoppingItem, QDistinct> distinctByQuantity() {
    return QueryBuilder.apply(this, (query) {
...
extension ShoppingItemQueryProperty
  ...
  QueryBuilder<ShoppingItem, bool, QQueryOperations> isBoughtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShoppingItem, double, QQueryOperations> priceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'price');
    });
  }

  QueryBuilder<ShoppingItem, int, QQueryOperations> quantityProperty() {
    return QueryBuilder.apply(this, (query) {
